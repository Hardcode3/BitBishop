...
class KingMoveGenerator : public PieceMoveGenerator {
 public:
   ...
   */
  static void add_king_castling(std::vector<Move>& moves, Square from, Color side, const Board& board);
   ...
   *
   */
  static bool can_castle_kingside(const Board& board, Color side);
   ...
   *
   */
  static bool can_castle_queenside(const Board& board, Color side);
};

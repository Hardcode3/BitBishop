...
TEST(BishopAttacksTest, CornerA1) {
  Bitboard bb = Lookups::BISHOP_RAYS[Square::A1];
...
TEST(BishopAttacksTest, CornerA8) {
  Bitboard bb = Lookups::BISHOP_RAYS[Square::A8];
...
TEST(BishopAttacksTest, CornerH1) {
  Bitboard bb = Lookups::BISHOP_RAYS[Square::H1];
...
TEST(BishopAttacksTest, CornerH8) {
  Bitboard bb = Lookups::BISHOP_RAYS[Square::H8];
...
TEST(BishopAttacksTest, CenterD4) {
  Bitboard bb = Lookups::BISHOP_RAYS[Square::D4];
